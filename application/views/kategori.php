                    ...
                    <ul class="nav navbar-nav navbar-left">
                        <li>
                            <form action="<?php echo base_url('admin/kategori/pencarian_kategori'); ?>" method="post">
                                <input class="search" type="text" placeholder="Pencarian" name="pencarian" >
                            </form>
                        </li>
                    </ul>
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <div class="card">
                        <form action="<?php echo base_url('admin/kategori/delete_multiple')?>" method="post">
                                            ...
                                            if (count($results)>0) 
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="checkbox" name="msg[]" value="<?php echo $result->id_category; ?>" data-toggle="checkbox">
                                                        </label>
                                                    </td>
